...
def main():
    ...
    opt_params = {
        ...
        # 'tp2_atr_multiplier': [2.0, 2.5, 3.0, 3.5],
        # 'tp3_atr_multiplier': [3.0, 3.5, 4.0, 4.5],
        # 'tp_position_size_1': [0.3, 0.4, 0.5],
        # 'tp_position_size_2': [0.2, 0.3, 0.4],
        # 'tp_position_size_3': [0.2, 0.3, 0.4],
    }
    
    # Create strategy class with constant parameters
    class OptimizedStrategy(TradingStrategy):
        ...
        rsi_overbought = 73
        atr_period = 14
        atr_multiplier = 2.564747433351312
        tp_atr_multiplier = 2.1891321013625737
        volume_sma_length = 10
        volume_surge_threshold = 1.4610780130177619
        volume_profile_period = 20
        vwap_deviation = 1.5
        swing_window = 5
        trend_window = 20
        bb_window = 23
        bb_dev = 2.0348975028599567
        macd_fast = 13
        macd_slow = 25
        macd_signal_length = 11
        use_volume_profile = False
        use_market_structure = False
        ...
        use_rsi = False
        use_volume = True
        weight_trend = 0.6317502278638265
        weight_momentum = 0.7749150853590359
        weight_volatility = 1.7521260567930441
        weight_volume = 2.1396738661930845
        weight_structure = 1.9491283437296396
        use_max_position_duration = False
        max_hold_period = 22
        use_breakeven_stop = True
        breakeven_threshold_atr = 1.3764492546070413
        breakeven_buffer_atr = 0.3453560452521312
    
    # Create and run backtest on training data using the optimized strategy
    bt = Backtest(train_data, OptimizedStrategy, cash=100000, commission=.002)
